...
(function () {
    ...
    const currentCompany = Object.freeze({
        ...
        name: 'IDEOL',
        shortName: 'IDEOL',
        legalName: 'İDEOL TURİZM TAŞIMACILIK İNŞ. GIDA PETROL SAN. TİC. LTD. ŞTİ.',
        logo: '',
        logoDark: '',
        logoLight: '',
        address: 'Keçili Köy Mah. Mimar Sinan Blv. No: 227 İç Kapı No: 6 Yunusemre / MANİSA',
        phone: '',
        email: '',
        taxOffice: 'Mesir',
        taxNumber: '4700570855',
        website: '',
        primaryColor: '#ff6b4a',
